...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private ImageView plcaeImage;
    private AutoCompleteTextView searchView;
    private RelativeLayout mRelativeLayout;
    private TextView namePlace, distancePlace;
    private ArrayList<DirectionsResult> mResult;
    private LatLng mCurrentLocation;
    private Location mLastLocation;
    //    private PlaceAutocompleteAdapter mPlaceAutoCompleteAdapter;
    private GoogleApiClient mGoogleApiClient;
    private TextView durationPlace;
    private static final int PERMISSIONS_REQUEST_ENABLE_GPS = 1;
    private static final int PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION = 2;
    private LatLngBounds mLatLng = new LatLngBounds(
            new LatLng(-40, -165), new LatLng(71, 136)
    );
...
//        recyclerView = (RecyclerView) findViewById(R.id.user_list_recycler_view);
        ...
        namePlace = (TextView) findViewById(R.id.name_of_place);
        distancePlace = (TextView) findViewById(R.id.name_of_distance);
        durationPlace = (TextView) findViewById(R.id.name_of_duration);
        plcaeImage = (ImageView) findViewById(R.id.location_image);
...
//                Picasso.get().load()getName
        ...
        /*searchView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                String placeId = searchView.getText().toString();
...
// Construct a request object, passing the place ID and fields array.
        ...
        mGoogleApiClient = new GoogleApiClient
                ...
                .build();
       /* mPlaceAutoCompleteAdapter = new PlaceAutocompleteAdapter(this, mGoogleApiClient,mLatLng, null);
...
//                mResult.add(result);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        View plusMinusButton = mMapView.findViewById(Integer.parseInt("1"));
        View locationButton = mMapView.findViewById(Integer.parseInt("2"));
...
//                    getChatrooms();
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mLastLocation != null) {
            ...
            Log.d(TAG, "onConnected: Instanciated");
        }
    }
